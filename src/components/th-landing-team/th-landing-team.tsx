  ...
  render() {
    return [
      <div class="container">
        ...
        <h2>Theranos is founded by core team member and former Ionic employee Dan Bucholtz.</h2>
        <div class="photo">
          <img src="/assets/images/dan.jpg"></img>
        </div>
        <div class="copy">
<p>Dan has been on the Ionic core team since the early days. As one of the lead developers on the team, and played an integral role in delivering the navigation system, the routing system, how overlay’s work, and was the chief architect behind the Ionic build process. He is an expert in all things Ionic.</p>
